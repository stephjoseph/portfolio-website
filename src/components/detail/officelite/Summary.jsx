    ...
    <section className="flex flex-col border-y border-solid border-[#33323D]/[0.15] py-6 md:flex-row md:gap-[0.75rem] md:py-8 xl:h-[41.77%] xl:w-[31.53%] xl:py-12">
      <div className="flex flex-col gap-6 md:w-[49.05%] md:gap-4 xl:w-full xl:gap-0">
        ...
        <a
          ...
          href="https://officelite-coming-soon-site-by-stephjoseph.netlify.app/"
          target="_blank"
        >
          Visit Website
        </a>
      ...
      <p className="hidden w-[49.20%] text-[0.938rem] font-normal leading-[1.875rem] tracking-normal text-[#33323D]/80 md:block xl:hidden">
        This project required me to build a fully responsive coming soon site to
        the designs provided. I used HTML5, along with CSS Flexbox and CSS Grid
        for layout purposes. I also used Tailwind as CSS Framework. The
        JavaScript this project required was for the sign-up form validation and
