import mobileTypemasterImg from "../../images/portfolio/mobile/image-portfolio-typemaster.jpg";
import tabletTypemasterImg from "../../images/portfolio/tablet/image-portfolio-typemaster.jpg";
import desktopTypemasterImg from "../../images/portfolio/desktop/image-portfolio-typemaster.jpg";
import { useEffect, useRef } from "react";
import { Link } from "react-router-dom";

const Typemaster = () => {
  const typemasterRef = useRef(null);
  ...
  return (
    ...
    >
      <div className="md:w-[49.20%] xl:w-[53.20%]">
        <img className="md:hidden" src={mobileTypemasterImg} alt="" />
        <img
          className="hidden md:block xl:hidden"
          src={tabletTypemasterImg}
          alt=""
        />
        <img className="hidden xl:block" src={desktopTypemasterImg} alt="" />
      </div>
