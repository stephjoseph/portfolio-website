import mobileMeetImg from "../../images/portfolio/mobile/image-portfolio-meet.jpg";
import tabletMeetImg from "../../images/portfolio/tablet/image-portfolio-meet.jpg";
import desktopMeetImg from "../../images/portfolio/desktop/image-portfolio-meet.jpg";
  ...
  return (
    ...
    >
      <div className="md:w-[49.20%] xl:w-[53.20%]">
        <img className="md:hidden" src={mobileMeetImg} alt="" />
        <img className="hidden md:block xl:hidden" src={tabletMeetImg} alt="" />
        <img className="hidden xl:block" src={desktopMeetImg} alt="" />
      </div>
      <div className="flex flex-col gap-6 border-y border-solid border-[#33323D]/[0.15] py-6 md:w-[40.78%] md:gap-0 md:pt-[2.063rem] md:pb-[3.125rem] xl:w-[34.48%] xl:py-[6.438rem]">
        ...
        <p className="text-[0.938rem] font-normal leading-[1.875rem] tracking-normal text-[#33323D]/80 md:mb-[2.188rem]">
          ...
          Grid. I also used Tailwind as CSS Framework.
        </p>
        <Link
